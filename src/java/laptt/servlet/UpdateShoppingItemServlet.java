...
@WebServlet(name = "UpdateShoppingItemServlet", urlPatterns = {"/UpdateShoppingItemServlet"})
public class UpdateShoppingItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (httpSession != null) {
                ...
                if (tblAccountDTO != null) {
                    if (tblAccountDTO.getRoleId() == 1) {
                        String shoppingItemId = request.getParameter("txtShoppingItemId");
                        ...
                        if (shoppingItemId != null && !shoppingItemId.isEmpty() && shoppingItemName != null && !shoppingItemName.isEmpty() && shoppingItemCategory != null && !shoppingItemCategory.isEmpty() && shoppingItemDescription != null && !shoppingItemDescription.isEmpty()) {
                            ...
                            String txtStatus = request.getParameter("txtShoppingItemStatus");
                            boolean status = txtStatus != null && txtStatus.equals("Active");
                            ...
                            tblShoppingItemDAO.updateTblShoppingItemDTOInDatabase(shoppingItemId, shoppingItemName, imagePath, shoppingItemCategory, shoppingItemDescription, status, shoppingItemQuantity, shoppingItemPrice);

                            httpSession = request.getSession(true);
                            httpSession.setAttribute("notification", "Update shopping item successfully!");
                        ...
                        httpSession = request.getSession(true);
                        httpSession.setAttribute("notification", "Update failed! Access denied.");
                    }
                }
            }
            ...
            e.printStackTrace();
            httpSession = request.getSession(true);
            httpSession.setAttribute("notification", "Update shopping item failed! Invalid input.");
