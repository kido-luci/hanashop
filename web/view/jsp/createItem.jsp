                    ...
                    <table class="cart-table">
                        ...
                        <form method="post" action="DispatchServlet" enctype="multipart/form-data">
                            <tr class="table-body-row admin-shopping">
                                ...
                                <td class="product-name"><input type="text" placeholder="name" name="txtShoppingItemName" value="${param.txtShoppingItemName}" style="width: 120px"></td>
                                <td class="product-price"><input type="number" step="0.1" placeholder="0" name="txtShoppingItemPrice" value="${param.txtShoppingItemPrice}" style="width: 120px"></td>
                                <td class="product-quantity"><input type="number" placeholder="0" name="txtShoppingItemQuantity" value="${param.txtShoppingItemQuantity}" style="width: 100px"></td>
                                <td class="product-quantity">
                                    <select name="txtShoppingItemCategory" size="1" style="width: 120px">
                                        <c:forEach var="shoppingItemCategory" items="${requestScope.ShoppingItemCategoryList}">
                                            <c:choose>
                                                <c:when test="${shoppingItemCategory == param.txtShoppingItemCategory}">
                                ...
                                <td><textarea name="txtShoppingItemDescription">${param.txtShoppingItemDescription}</textarea></td>
                                <td>
                                ...
                                <td>
                                    <button class="shopping-table-btn" name="btAction" value="createShoppingItem">
                                        Create Item
                                    </button>
                                </td>
                            </tr>
